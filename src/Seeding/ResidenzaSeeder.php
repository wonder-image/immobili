...
final class ResidenzaSeeder
{
    ...
    private const DEMO = [
        ...
        [
            ...
            'features' => ['terrazzo', 'ascensore', 'fotovoltaico', 'solare_termico', 'frangisole', 'videosorveglianza'],
        ...
        [
            ...
            'features' => ['domotica', 'climatizzazione', 'riscaldamento_pavimento', 'ventilazione_meccanica', 'allarme', 'box_auto', 'cantina'],
        ...
        [
            ...
            'features' => ['giardino', 'fotovoltaico', 'riscaldamento_autonomo', 'area_verde'],
        ...
        [
            ...
            'features' => ['ascensore', 'terrazzo', 'cantina', 'predisposizione_allarme', 'posizione_centrale'],
    ...
    public function seed(): int
    {
        ...
        foreach (self::DEMO as $i => $demo) {
            ...
            $data = [
                ...
                'unita_commerciali' => (string) (int) floor(((int) $demo['unita']) / 8),
                'box'               => (string) $demo['unita'],
