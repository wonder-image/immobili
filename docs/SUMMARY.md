...
* [Installazione](getting-started/installazione.md)
* [Struttura del modulo](getting-started/struttura-modulo.md)
* [Sito di test (boilerplate)](getting-started/sito-di-test.md)

## Configurazione

* [Feed e gestionali](configurazione/feed-e-gestionali.md)
* [Impostazioni](configurazione/impostazioni.md)
* [Permessi e ruoli](configurazione/permessi.md)

## Provider

* [Getrix](provider/getrix.md)
* [Gestim](provider/gestim.md)
* [Idealista (export)](provider/idealista.md)
...
* [Sviluppo e test](riferimento/sviluppo-e-test.md)
