...
/**
 * Immagine o gallery interna di una card residenza.
 *
 * @var array $args [
 *     'residenza' => array,
...
<button type="button" class="p-a immobili-card__nav immobili-card__nav--prev" data-immobili-gallery-prev
        aria-label="<?= e(__t('components.residenze.card.gallery_prev')) ?>"><i class="bi bi-chevron-left"></i></button>
<button type="button" class="p-a immobili-card__nav immobili-card__nav--next" data-immobili-gallery-next
        aria-label="<?= e(__t('components.residenze.card.gallery_next')) ?>"><i class="bi bi-chevron-right"></i></button>
